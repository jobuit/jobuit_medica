...
if(!function_exists('load_bootstrap')){
	...
	{
		$bootstrap = "";
		$bootstrap .="<link href='http://localhost/proyecto_ejemplo/plantillas/vendor/bootstrap/css/bootstrap.min.css' rel=\"stylesheet\">";
...
if(!function_exists('form_input_file')){
	...
	{	
		$div  = "<div class='form-group'>";
		$div .= "<input name='file_name' type='file' id='file_name' class='filestyle' data-icon='true' data-buttonText='$texto' required=''>";
		$div .= "</div>";
		return $div;
	}
}
...
if ( ! function_exists('form_submit'))
{
    function form_submit($message = '', $class = '')
    {
    	...
    	return "<div class='form-group'><input type='submit' class='". $class ."' name='upload' value='$message'/></div>";
    }   
}
